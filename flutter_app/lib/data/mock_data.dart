...
final List<Category> initialCategories = [
  Category(id: 'cat-clothing', name: LocalizedString(en: 'Clothing', ar: 'الملابس'), group: 'Shops', iconName: 'Shirt'),
  Category(id: 'cat-grocery', name: LocalizedString(en: 'Grocery', ar: 'البقالة'), group: 'Shops', iconName: 'ShoppingBag'),
  Category(id: 'cat-education', name: LocalizedString(en: 'Education', ar: 'التعليم'), group: 'Shops', iconName: 'BookOpen'),
  Category(id: 'cat-electronics', name: LocalizedString(en: 'Electronics', ar: 'الإلكترونيات'), group: 'Shops', iconName: 'Tv'),
  Category(id: 'cat-jewelry', name: LocalizedString(en: 'Jewelry', ar: 'المجوهرات'), group: 'Shops', iconName: 'Gem'),
  Category(id: 'cat-books', name: LocalizedString(en: 'Books', ar: 'الكتب'), group: 'Shops', iconName: 'Book'),
  Category(id: 'cat-plumbing', name: LocalizedString(en: 'Plumbing', ar: 'السباكة'), group: 'Services', iconName: 'Wrench'),
  Category(id: 'cat-electrical', name: LocalizedString(en: 'Electrical', ar: 'الكهرباء'), group: 'Services', iconName: 'Zap'),
  Category(id: 'cat-carpentry', name: LocalizedString(en: 'Carpentry', ar: 'النجارة'), group: 'Services', iconName: 'Hammer'),
  Category(id: 'cat-cleaning', name: LocalizedString(en: 'Cleaning', ar: 'خدمات التنظيف'), group: 'Services', iconName: 'Sparkles'),
  Category(id: 'cat-maintenance', name: LocalizedString(en: 'Maintenance', ar: 'الصيانة العامة'), group: 'Services', iconName: 'Settings'),
  Category(id: 'cat-doctor', name: LocalizedString(en: 'Doctors', ar: 'الأطباء'), group: 'Professionals', iconName: 'UserCheck'),
  Category(id: 'cat-lawyer', name: LocalizedString(en: 'Lawyers', ar: 'المحاماة'), group: 'Professionals', iconName: 'Scale'),
  Category(id: 'cat-engineer', name: LocalizedString(en: 'Engineers', ar: 'الهندسة'), group: 'Professionals', iconName: 'HardHat'),
  Category(id: 'cat-accountant', name: LocalizedString(en: 'Accountants', ar: 'المحاسبة'), group: 'Professionals', iconName: 'Calculator'),
  Category(id: 'cat-realestate', name: LocalizedString(en: 'Real Estate', ar: 'العقارات'), group: 'Professionals', iconName: 'Building'),
  Category(id: 'cat-restaurant', name: LocalizedString(en: 'Restaurants', ar: 'المطاعم'), group: 'Food', iconName: 'Utensils'),
  Category(id: 'cat-bakery', name: LocalizedString(en: 'Bakery', ar: 'المخبز'), group: 'Food', iconName: 'Croissant'),
  Category(id: 'cat-catering', name: LocalizedString(en: 'Catering', ar: 'التجهيزات الغذائية'), group: 'Food', iconName: 'Soup'),
];
...
final List<Business> initialBusinesses = [
  Business(
    ...
    subcategory: LocalizedString(en: 'Grocery Store', ar: 'متجر بقالة'),
    ...
    workingHours: LocalizedString(en: '8:00 AM - 11:00 PM', ar: '8:00 صباحاً - 11:00 مساءً'),
  ...
  Business(
    ...
    subcategory: LocalizedString(en: 'Electrician', ar: 'كهربائي متميز'),
    ...
    website: '',
    workingHours: LocalizedString(en: '9:00 AM - 9:00 PM (24/7 Available for emergency)', ar: '9:00 صباحاً - 9:00 مساءً (متوفر 24/7 للطوارئ)'),
  ...
  Business(
    ...
    subcategory: LocalizedString(en: 'Clothing Shop', ar: 'متجر ملابس'),
    ...
    workingHours: LocalizedString(en: '10:00 AM - 10:00 PM', ar: '10:00 صباحاً - 10:00 مساءً'),
  ...
  Business(
    ...
    subcategory: LocalizedString(en: 'Restaurant', ar: 'مطعم ومطابخ'),
    ...
    website: '',
    workingHours: LocalizedString(en: '11:00 AM - 12:00 AM', ar: '11:00 صباحاً - 12:00 منتصف الليل'),
  ...
  Business(
    ...
    subcategory: LocalizedString(en: 'Doctor', ar: 'طبيب استشاري'),
    ...
    website: '',
    workingHours: LocalizedString(en: '3:00 PM - 9:00 PM', ar: '3:00 مساءً - 9:00 مساءً'),
  ...
  Business(
    ...
    subcategory: LocalizedString(en: 'Bookstore', ar: 'مكتبة ودار نشر'),
    ...
    workingHours: LocalizedString(en: '9:00 AM - 10:00 PM', ar: '9:00 صباحاً - 10:00 مساءً'),
  ...
  Business(
    ...
    subcategory: LocalizedString(en: 'Cleaning Service', ar: 'خدمات تنظيف'),
    ...
    website: '',
    workingHours: LocalizedString(en: '8:00 AM - 6:00 PM', ar: '8:00 صباحاً - 6:00 مساءً'),
  ...
  Business(
    ...
    categoryId: 'cat-restaurant',
    subcategory: LocalizedString(en: 'Restaurant', ar: 'مطعم عائلي'),
    ...
    website: '',
    workingHours: LocalizedString(en: '12:00 PM - 11:00 PM', ar: '12:00 ظهراً - 11:00 مساءً'),
  ...
  Business(
    ...
    categoryId: 'cat-doctor',
    subcategory: LocalizedString(en: 'Women\'s Health Specialist', ar: 'أخصائية نساء وتوليد'),
    ...
    website: '',
    workingHours: LocalizedString(en: '9:00 AM - 2:00 PM | 5:00 PM - 8:00 PM', ar: '9:00 صباحاً - 2:00 ظهراً | 5:00 مساءً - 8:00 مساءً'),
  ...
  Business(
    ...
    subcategory: LocalizedString(en: 'Accountant', ar: 'محاسب قانوني معتمد'),
    ...
    workingHours: LocalizedString(en: '9:00 AM - 5:00 PM (Sat-Thu)', ar: '9:00 صباحاً - 5:00 مساءً (السبت-الخميس)'),
...
final List<PaymentRecord> initialPayments = [
  PaymentRecord(id: 'pay-1', businessId: 'biz-alkawthar', amount: 50, date: '2026-06-15', status: 'success', refNo: 'TXN-7348912'),
  PaymentRecord(id: 'pay-2', businessId: 'biz-noor', amount: 50, date: '2026-06-11', status: 'success', refNo: 'TXN-8291047'),
  PaymentRecord(id: 'pay-3', businessId: 'biz-fatima', amount: 50, date: '2026-06-01', status: 'success', refNo: 'TXN-1029486'),
  PaymentRecord(id: 'pay-4', businessId: 'biz-hussaini', amount: 50, date: '2026-06-15', status: 'success', refNo: 'TXN-6571932'),
  PaymentRecord(id: 'pay-5', businessId: 'biz-basra-clean', amount: 50, date: '2026-06-18', status: 'success', refNo: 'TXN-9012345'),
  PaymentRecord(id: 'pay-6', businessId: 'biz-erbil-restaurant', amount: 50, date: '2026-06-20', status: 'success', refNo: 'TXN-3456789'),
  PaymentRecord(id: 'pay-7', businessId: 'biz-karbala-dr', amount: 50, date: '2026-06-22', status: 'success', refNo: 'TXN-5678901'),
  PaymentRecord(id: 'pay-8', businessId: 'biz-baghdad-acc', amount: 50, date: '2026-06-25', status: 'success', refNo: 'TXN-7890123'),
];
...
final List<Product> initialProducts = [
  Product(
    id: 'prod-1',
    businessId: 'biz-alkawthar',
    name: LocalizedString(en: 'Organic Honey', ar: 'عسل عضوي'),
    description: LocalizedString(en: 'Pure natural honey from local farms.', ar: 'عسل طبيعي نقي من المزارع المحلية.'),
    price: 25.0,
  ...
  Product(
    id: 'prod-2',
    businessId: 'biz-alkawthar',
    name: LocalizedString(en: 'Premium Dates', ar: 'تمور فاخرة'),
    description: LocalizedString(en: 'High-quality Ajwa dates.', ar: 'تمور عجوة عالية الجودة.'),
    price: 15.0,
  ...
  Product(
    ...
    name: LocalizedString(en: "Premium Linen Kurta", ar: "Premium Linen Kurta"),
    description: LocalizedString(en: "A premium linen kurta.", ar: "A premium linen kurta."),
    price: 45.0,
    inStock: true,
  ...
  Product(
    id: "p2",
    businessId: 'business-businessshiadirectorycom',
    name: LocalizedString(en: "Casual Cotton Shirt", ar: "Casual Cotton Shirt"),
    description: LocalizedString(en: "A casual cotton shirt.", ar: "A casual cotton shirt."),
    price: 35.0,
    inStock: true,
    imageUrl: "https://via.placeholder.com/150",
  ),
  Product(
    id: "p3",
    businessId: 'business-businessshiadirectorycom',
    name: LocalizedString(en: "Embroidered Traditional Wear", ar: "Embroidered Traditional Wear"),
    description: LocalizedString(en: "Embroidered traditional wear.", ar: "Embroidered traditional wear."),
    price: 75.0,
    inStock: false,
    imageUrl: "https://via.placeholder.com/150",
  ),
...
final List<Order> initialOrders = [
  Order(
    ...
    items: [OrderItem(productId: 'prod-1', quantity: 2, priceAtPurchase: 25.0)],
    totalAmount: 50.0,
    status: 'pending',
    date: '2026-07-02',
  ),
  Order(
    ...
    items: [OrderItem(productId: 'prod-2', quantity: 1, priceAtPurchase: 15.0)],
    totalAmount: 15.0,
    status: 'processing',
    date: '2026-07-03',
  ),
  Order(
    ...
    items: [OrderItem(productId: 'prod-1', quantity: 1, priceAtPurchase: 25.0), OrderItem(productId: 'prod-2', quantity: 3, priceAtPurchase: 15.0)],
    totalAmount: 70.0,
    status: 'delivered',
    date: '2026-06-25',
  ),
